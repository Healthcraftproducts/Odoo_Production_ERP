                        ...
                        for line in sale.order_line:
                            if not line.display_type:
                                if line.discount > 0.0:
                                    a = sale.id
                                    b = [sale.name, sale.partner_id.hcp_customer_id, sale.partner_id.name,
                                         line.product_id.default_code, line.product_id.name, line.discount,
                                         line.line_amount * line.discount / 100, line.line_amount]
