    ...
    def _split_productions(self, amounts=False, cancel_remaining_qty=False, set_consumed_qty=False):
        ...
        for production in self:
            ...
            for workorder in production.workorder_ids:
                initial_workorder_remaining_qty.append(max(initial_qty - workorder.qty_reported_from_previous_wo - workorder.record_qty_production, 0))
                workorder.record_qty_production = min(workorder.record_qty_production, workorder.qty_production)
